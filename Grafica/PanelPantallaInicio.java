...
public class PanelPantallaInicio extends PanelVista {

    protected Image imagenFondo;
    protected JButton botonJugar;


    protected PanelPantallaInicio(ControladorVistas controladorVistas) {
        super(controladorVistas);

        java.net.URL url = getClass().getResource("/Imagenes/SpritesOriginales/Pantallas/pantalla-jugar.png");
        if (url == null) {
    ...
    protected void inicializarComponentes() {
        ...
        c.insets = new Insets(0, 0, 170, 0);
        c.fill = GridBagConstraints.NONE;

        add(botonJugar, c);

        botonJugar.addActionListener(e -> controladorVistas.mostrarPanelPantallaDominio());
    }
}