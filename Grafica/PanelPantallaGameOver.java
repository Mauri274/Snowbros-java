...
public class PanelPantallaGameOver extends PanelVista {
    ...
    protected PanelPantallaGameOver(ControladorVistas controladorVistas) {
        super(controladorVistas);

        java.net.URL url = getClass().getResource("/Imagenes/SpritesOriginales/Pantallas/game-over.png");
        if (url == null) {
            throw new IllegalStateException("No se encontró /Imagenes/SpritesOriginales/Pantallas/game-over.png en el classpath");
        }
